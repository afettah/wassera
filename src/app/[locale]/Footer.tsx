  ...
  return (
    <footer className="bg-[#1f382b] text-white relative overflow-hidden mt-10">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-64 h-64 bg-white transform -translate-x-1/2 -translate-y-1/2 rotate-45"></div>
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-white transform translate-x-1/2 translate-y-1/2 rotate-45"></div>
        <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-white transform -translate-x-1/2 -translate-y-1/2 rotate-45"></div>
        <div className="absolute top-3/4 right-1/3 w-48 h-48 bg-white transform translate-x-1/2 -translate-y-1/2 rotate-45"></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <Link href="/" className="flex items-center">
              <div className="flex flex-col font-bold text-2xl leading-none">
