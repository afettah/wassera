...
function renderTechnologyProviders() {
  const category = partnerCategories.find(
    (category) => category.title === "Technology Providers"
  );
  return (
    <div>
...
function renderPotentialClients() {
  const category = partnerCategories.find(
    (category) => category.title === "Potential Clients"
  );
  return (
    <div>
      <h3 className="text-xl font-semibold mb-4 text-center">
...
function renderRegulatoryBodies() {
  const category = partnerCategories.find(
    (category) => category.title === "Regulatory Bodies"
  );
  return (
    <div>
      <h3 className="text-xl font-semibold mb-4 text-center">
    ...
    <Container className="py-14">
      <div>
        ...
        <p className="text-center text-secondary-foreground text-lg mb-8 my-4">
          Our relationships prepare businesses for the future. We work with a
          trusted, select group of partners.
        </p>
